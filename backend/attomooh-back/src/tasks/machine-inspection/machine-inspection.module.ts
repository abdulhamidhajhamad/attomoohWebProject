...
import { MachineInspection, MachineInspectionSchema } from './schemas/machine-inspection.schema.js';
...
@Module({
  imports: [MongooseModule.forFeature([{ name: MachineInspection.name, schema: MachineInspectionSchema }])],
