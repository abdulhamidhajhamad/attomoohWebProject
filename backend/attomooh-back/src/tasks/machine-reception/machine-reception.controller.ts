...
import {
  CreateMachineReceptionDto,
  UpdateMachineReceptionDto,
} from './dto/index.js';
...
export class MachineReceptionController {
  ...
  async create(@Body() dto: CreateMachineReceptionDto) {
  ...
  async findAll(
    ...
    const shouldExcludeAssigned =
      excludeAssigned === 'true' || excludeAssigned === '1';
    const shouldIncludeExternalPending =
      includeExternalPending === 'true' || includeExternalPending === '1';
  ...
  async update(
    ...
    @Body() dto: UpdateMachineReceptionDto,
  ) {
  ...
  async delete(@Param('id', ParseObjectIdPipe) id: Types.ObjectId) {
    ...
    return { message: 'Machine reception deleted successfully' };
  }
}
