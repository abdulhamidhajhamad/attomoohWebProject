...
export class VehiclesService {
  constructor(private readonly repo: VehicleRepository, private readonly idGen: IdGeneratorService) {}
  ...
  async findAll(): Promise<VehicleDocument[]> { return this.repo.findAll(); }
  ...
  async delete(id: Types.ObjectId): Promise<void> { const deleted = await this.repo.deleteById(id); if (!deleted) throw new NotFoundException('Vehicle not found'); }
}
