...
export class VehicleRepository {
  ...
  async create(data: Partial<Vehicle>): Promise<VehicleDocument> {
    ...
    return this.findById(doc._id as Types.ObjectId) as Promise<VehicleDocument>;
  }
  ...
  async updateById(id: Types.ObjectId, data: Partial<Vehicle>): Promise<VehicleDocument | null> {
    return this.model
