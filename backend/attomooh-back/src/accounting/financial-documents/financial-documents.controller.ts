...
export class FinancialDocumentsController {
  ...
  async create(@Body() dto: CreateFinancialDocumentDto) {
    return this.svc.create(dto);
  }

  @Get()
  async findAll(@Query('type') type?: FinancialDocType) {
    return this.svc.findAll(type);
  }

  @Get('by-customer/:customerId')
  async findByCustomer(
    @Param('customerId', ParseObjectIdPipe) id: Types.ObjectId,
  ) {
  ...
  async findBySupplier(
    @Param('supplierId', ParseObjectIdPipe) id: Types.ObjectId,
  ) {
    return this.svc.findBySupplier(id);
  }

  @Get('by-technician/:technicianId')
  async findByTechnician(
    @Param('technicianId', ParseObjectIdPipe) id: Types.ObjectId,
  ) {
  ...
  async delete(@Param('id', ParseObjectIdPipe) id: Types.ObjectId) {
    ...
    return { message: 'Financial document deleted' };
  }
}
