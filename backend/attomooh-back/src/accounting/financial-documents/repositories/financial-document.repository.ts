...
import {
  FinancialDocument,
  FinancialDocumentDocument,
} from '../schemas/financial-document.schema.js';
...
export class FinancialDocumentRepository {
  constructor(
    ...
    private readonly model: Model<FinancialDocumentDocument>,
  ) {}

  async create(
    data: Partial<FinancialDocument>,
  ...
  async findById(
    id: Types.ObjectId,
  ): Promise<FinancialDocumentDocument | null> {
    return this.model
      .findById(id)
      .populate('customer')
      .populate('supplier')
  ...
  async findBySupplier(
    ...
    return this.findAll({ supplier: supplierId });
  }
  async findByTechnician(
    technicianId: Types.ObjectId,
  ): Promise<FinancialDocumentDocument[]> {
    return this.findAll({ technician: technicianId });
  }
