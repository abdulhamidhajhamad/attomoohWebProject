...
export class PurchaseOrder {
  ...
  @Prop({ type: Types.ObjectId, ref: 'User', default: null }) requestedBy: Types.ObjectId;
  @Prop({ default: '' }) requestedByName: string;
  @Prop({ enum: MaterialType, default: MaterialType.SPARE_PARTS }) materialType: MaterialType;
  ...
  @Prop({ type: Types.ObjectId, ref: 'Supplier', default: null }) supplier: Types.ObjectId;
