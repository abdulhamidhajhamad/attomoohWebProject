...
export default function MachineMaintenancePage() {
  ...
  const startEdit = useCallback((r: ApiMachineMaint) => { setEditId(r._id); setEditForm({ machineName: r.machineName, machineDetails: r.machineDetails, technicianName: r.technicianName, date: r.date, technicianReport: r.technicianReport }); }, []);
